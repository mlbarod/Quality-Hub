...
- 기본 `--cpu-budget 1.75`
- 기본값 `1.75`는 평균 CPU 사용 목표이며, Linux에서는 브라우저 대기를 숨길 수 있도록 최대 4개 논리 CPU affinity를 허용합니다.
...
- 기본 설정에서는 명령 검사를 먼저 끝낸 뒤 대기형 브라우저 작업을 별도 Chromium 프로필 최대 8개에 가중치 균형 배치합니다.
